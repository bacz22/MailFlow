  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col p-0 overflow-hidden">
        {/* Header Bar */}
        <div className="p-4 sm:p-5 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="pt-6 border-t border-slate-200 dark:border-slate-800 text-center space-y-1.5 text-[10px] text-slate-400">
                ...
                <p>
                  Bạn nhận được email này vì đã đăng ký nhận tin. Nhấn{' '}
                  <span className="underline text-blue-600 cursor-pointer">hủy đăng ký tại đây</span> nếu không còn quan tâm.
                </p>
              </div>
            </div>
          </div>
